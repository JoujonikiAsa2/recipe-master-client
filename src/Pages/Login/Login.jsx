...
import amimatedDat4 from "./Animation4.json"
...
const Login = () => {
    return (
        <div className="relative top-28 pb-20 flex flex-col-reverse md:flex-row lg:flex-row  gap-3 justify-center items-center mooli w-full">
            <div className="w-1/2 shadow-xl p-10 bg-white bg-opacity-80">
                ...
                <div className="py-10">
                    <form>
                        ...
                        <input type="submit" value="Login" className="w-full input input-bordered mt-4 bg-orange-400" />

                        <div className="w-full flex flex-col justify-center itens-center gap-3  py-6">
                            <p className="text-xl text-center font-bold">Or <br /><span className="text-lg font-normal">login with</span></p>
            ...
            <div className="w-4 h-96 bg-orange-400 hidden md:block lg:block"></div>
            <div className="w-1/2">
                <Lottie animationData={amimatedDat4} loop={true} autoPlay={true} className="h-[300px]"></Lottie>
            </div>
        </div>
    );
};
